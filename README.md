...
<p align="center">
  <strong><a href="https://github.com/LielZ/Pame/releases/download/v0.4.5/Pame-Setup-0.4.5-x64.exe">Download for Windows</a></strong>
  &nbsp; · &nbsp;
  <a href="https://github.com/LielZ/Pame/releases/tag/v0.4.5">Release notes</a>
  &nbsp; · &nbsp;
...
<p align="center"><sub>PUBLIC ALPHA 0.4.5 &nbsp; / &nbsp; WINDOWS 10 2004+ &nbsp; / &nbsp; x64</sub></p>
...
1. **[Download the Windows installer](https://github.com/LielZ/Pame/releases/download/v0.4.5/Pame-Setup-0.4.5-x64.exe)** and run it. The .NET runtime is included; setup installs Microsoft WebView2 if needed.
...
| **[Validation](docs/VALIDATION-0.4.5.md)** | Automated checks and native integration results for 0.4.5. |
...
<p align="center">
  ...
  <a href="THIRD_PARTY_NOTICES.md">Third-party notices</a> · <a href="DEPENDENCIES.md">Dependencies</a> · <a href="https://github.com/LielZ/Pame/releases/download/v0.4.5/SHA256SUMS.txt">Installer checksum</a></sub>
</p>
